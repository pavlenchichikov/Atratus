...
class TestLynchAnalysis:
    def test_undervalued(self):
        ...
        status, _desc, score = lynch_analysis(fund, None)
    ...
    def test_technical_fallback(self):
        ...
        status, _desc, score = lynch_analysis(None, tech)
        assert "MOMENTUM" in status
        assert score == 2

    def test_no_data(self):
        status, _desc, score = lynch_analysis(None, None)
...
class TestBuffettAnalysis:
    def test_high_quality(self):
        ...
        status, _desc, score = buffett_analysis(fund, None)
...
class TestGrahamAnalysis:
    def test_cheap_stock(self):
        ...
        _status, _desc, score = graham_analysis(fund, None)
        assert score >= 2
...
class TestMungerAnalysis:
    def test_clean(self):
        ...
        status, _desc, _score = munger_analysis(fund, tech)
